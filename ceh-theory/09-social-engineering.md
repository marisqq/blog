...
Pharming - redirects traffic to attackers website, DNS cache poisoning, host file modifications
...
Phishing tools:
ShellPhish - social networks
Social engineering toolkit - email, WEB and USB attacks
...
Angler phishing:
fake social media account impersonating org to post heldesk service links
